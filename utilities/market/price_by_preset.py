...
def main() -> None:
    _cfg3, _root3 = _get_eve_cfg()
    default_region_ids = parse_region_ids(str(_cfg3.get("fetch", {}).get("region_ids", DEFAULT_REGION_IDS))) or DEFAULT_REGION_IDS
    ...
    alias_file = resolve_path(repo_root, "Data/Materials/alias.json")
    preset_file = resolve_path(repo_root, "Data/Materials/preset.json")
    cache_dir = resolve_path(repo_root, "Cache/Market")
